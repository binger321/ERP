...
public class GoodsBrandExample {
    ...
    public static class SelectiveField {
        ...
        private static String allFields = "id,brand_code,brand_name,country_code,country_name,remark,status,block_time,creator,create_time,modifier,modify_time";
        ...
        public SelectiveField brandCode() {
            fields.add("brand_code");
            return this;
        }

        public SelectiveField brandName() {
