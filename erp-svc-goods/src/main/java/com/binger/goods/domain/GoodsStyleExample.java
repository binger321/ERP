...
public class GoodsStyleExample {
    /**
     * goods_style
     */
    ...
    public static class SelectiveField {
        ...
        private static String allFields = "id,style_code,style_name,remark,status,block_time,creator,create_time,modifier,modify_time";
        ...
        public SelectiveField styleCode() {
            fields.add("style_code");
            return this;
        }

        public SelectiveField styleName() {
            fields.add("style_name");
            return this;
        }
